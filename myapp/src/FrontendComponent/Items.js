...
function Items() {
    ...
    // { token == '' ? token=tokenP : null};
    const token = localStorage.getItem('token');
    const userid = localStorage.getItem('userid');
    // let userid = localStorage.getItem('userid');
    // { userid == '' ? userid=useridP : null};
    ...
    function fetchToken() {
        ...
        axiosPromise?.then(data => {
            ...
            if (data["data"]["userid"]) {
                if (data["data"]["token"] != token || data["data"]["userid"] != userid || roleBasedAccess != "user") {
                    alert("Bad Request !!")
                    localStorage.clear();
                    navigate('/usersignin')
    ...
    function getFdata() {
        const axiosPromise = axios.get('http://127.0.0.1:5000/itemalluser')
                ...
                <div className='token-class'>
                    <div className="container-fluid center row">
                        <div className="container col-lg-4 bdr center mt-5" >
                            <form onSubmit={handleSubmit1} data-testid="your-form">
                                <div >
                                    ...
                                    <div >
                                        ...
                                        <textarea className="form-control" onChange={handleData1} data-testid="instructions-input" id="instructions" placeholder="comments..." name="instructions" rows="3" ></textarea>
                                    </div>
